...
import { Brain, Sparkles, Target, BarChart3, Clock, Users, Check, ArrowRight, Play, RefreshCw, BookOpen, Zap } from 'lucide-react';
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-white/30">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">5 AI-generated study sets</span>
                </li>
                <li className="flex items-center space-x-3">
                  <Check className="w-5 h-5 text-emerald-500" />
                  <span className="text-gray-700">Basic active recall sessions</span>
                </li>
                <li className="flex items-center space-x-3">
                  <Check className="w-5 h-5 text-emerald-500" />
                  <span className="text-gray-700">Simple progress tracking</span>
                </li>
                <li className="flex items-center space-x-3">
                  <Check className="w-5 h-5 text-emerald-500" />
            ...
            <div className="bg-gradient-to-br from-indigo-500 to-purple-500 rounded-2xl p-8 text-white relative overflow-hidden">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-center space-x-3">
                  ...
                  <span>Unlimited AI study sets</span>
                </li>
                <li className="flex items-center space-x-3">
                  <Check className="w-5 h-5 text-white" />
                  <span>Advanced FSRS algorithm</span>
                </li>
                <li className="flex items-center space-x-3">
                  <Check className="w-5 h-5 text-white" />
